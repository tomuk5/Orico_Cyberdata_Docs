...
Fan connectors on the board are 4pin JST PH (2.0mm pitch between pins) connectors in the same pinout orientation as normal 4 pin pc fan - (WIP)
...
There is a 4pin JST PH (2.0mm pitch between pins) towards the front right of the board for Serial Debug (pinout shown on the PCB silk screen). (signalling voltage and function as yet untested)